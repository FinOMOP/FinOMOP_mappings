...
|FHL                  |WARNING |Not APPROVED mappingStatus with concepts outdated        |2 conceptNames are outdated, 22 standardConcepts have changed to non-standard                               |
...
|ICD8fi               |ERROR   |APPROVED mappingStatus with concepts outdated            |6 conceptNames are outdated, 26 domainIds are outdated, 7 standardConcepts have changed to non-standard     |
|ICD8fi               |WARNING |Not APPROVED mappingStatus with concepts outdated        |4 conceptNames are outdated, 11 domainIds are outdated, 24 standardConcepts have changed to non-standard    |
...
|ICD9fi               |ERROR   |APPROVED mappingStatus with concepts outdated            |21 conceptNames are outdated, 55 domainIds are outdated, 68 standardConcepts have changed to non-standard   |
|ICD9fi               |WARNING |Not APPROVED mappingStatus with concepts outdated        |11 domainIds are outdated, 6 standardConcepts have changed to non-standard                                  |
...
|ICD10fi              |ERROR   |APPROVED mappingStatus with concepts outdated            |27 conceptNames are outdated, 16 domainIds are outdated, 21 standardConcepts have changed to non-standard   |
|ICD10fi              |WARNING |Not APPROVED mappingStatus with concepts outdated        |1 standardConcepts have changed to non-standard                                                             |
...
|MICROBEfi            |ERROR   |APPROVED mappingStatus with concepts outdated            |11 conceptNames are outdated, 1 standardConcepts have changed to non-standard                               |
...
|MICROBEfi_TKU        |ERROR   |APPROVED mappingStatus with concepts outdated            |4 conceptNames are outdated                                                                                 |
...
|NCSPfi               |ERROR   |APPROVED mappingStatus with concepts outdated            |36 conceptNames are outdated, 1 domainIds are outdated, 131 standardConcepts have changed to non-standard   |
|NCSPfi               |WARNING |Not APPROVED mappingStatus with concepts outdated        |97 conceptNames are outdated, 11 domainIds are outdated, 146 standardConcepts have changed to non-standard  |
...
|SNOMED2fi            |ERROR   |APPROVED mappingStatus with concepts outdated            |5 conceptNames are outdated, 531 domainIds are outdated, 20 standardConcepts have changed to non-standard   |
|SNOMED2fi            |WARNING |Not APPROVED mappingStatus with concepts outdated        |30 conceptNames are outdated, 1798 domainIds are outdated, 73 standardConcepts have changed to non-standard |
...
|ProcedureModifier    |ERROR   |APPROVED mappingStatus with concepts outdated            |1 conceptNames are outdated                                                                                 |
...
|REIMB                |WARNING |Not APPROVED mappingStatus with concepts outdated        |3 domainIds are outdated                                                                                    |
...
|SPAT                 |WARNING |Not APPROVED mappingStatus with concepts outdated        |2 conceptNames are outdated, 2 standardConcepts have changed to non-standard                                |
...
|VNRfi                |ERROR   |APPROVED mappingStatus with concepts outdated            |3 conceptNames are outdated, 3 standardConcepts have changed to non-standard                                |
...
|ICPC                 |ERROR   |APPROVED mappingStatus with concepts outdated            |28 domainIds are outdated, 2 standardConcepts have changed to non-standard                                  |
|ICPC                 |WARNING |Not APPROVED mappingStatus with concepts outdated        |10 domainIds are outdated                                                                                   |
...
|HPO                  |WARNING |Not APPROVED mappingStatus with concepts outdated        |1 domainIds are outdated                                                                                    |
...
|ProfessionalCode     |WARNING |Not APPROVED mappingStatus with concepts outdated        |2 conceptNames are outdated, 1 domainIds are outdated                                                       |
...
|FGVisitType          |ERROR   |APPROVED mappingStatus with concepts outdated            |1 domainIds are outdated                                                                                    |
