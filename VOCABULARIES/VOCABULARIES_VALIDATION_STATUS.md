...
|SNOMED2fi            |ERROR   |APPROVED mappingStatus with valid domain combination     |Found 1 codes with invalid domain combinations       |
...
|ICPC                 |ERROR   |APPROVED mappingStatus with concepts outdated            |2 conceptIds do not exist on the target vocabularies |
