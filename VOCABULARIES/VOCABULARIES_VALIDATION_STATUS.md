...
|MEDSPECfi            |      25|       0|     0|
|MICROBEfi            |      25|       0|     0|
|MICROBEfi_TKU        |      25|       0|     0|
|NCSPfi               |      25|       0|     0|
|SNOMED2fi            |      25|       0|     0|
|ProcedureModifier    |      25|       0|     0|
|REIMB                |      25|       0|     0|
|SPAT                 |      25|       0|     0|
|UNITfi               |      25|       0|     0|
|VNRfi                |      19|       0|     6|
|ICPC                 |      25|       0|     0|
|HPO                  |      25|       0|     0|
|ProfessionalCode     |      25|       0|     0|
|FGVisitType          |      25|       0|     0|
|LABfi_ALL            |      25|       0|     0|
|KantaServiceProvider |      25|       0|     0|
...
|VNRfi                |ERROR   |MappingStatus is not valid                               |Number of failed rules:  239                      |
...
|VNRfi                |ERROR   |SourceConceptId is not a number on the range             |Number of failed rules:  239                      |
|VNRfi                |SUCCESS |SourceConceptClass is empty                              |                                                  |
|VNRfi                |ERROR   |SourceConceptClass is more than 20 characters            |Number of failed rules:  68                       |
|VNRfi                |ERROR   |SourceDomain is empty                                    |Number of failed rules:  150                      |
|VNRfi                |SUCCESS |SourceDomain is not a valid domain                       |                                                  |
|VNRfi                |SUCCESS |Not APPROVED mappingStatus with valid domain combination |                                                  |
|VNRfi                |ERROR   |APPROVED mappingStatus with valid domain combination     |Found 218 codes with invalid domain combinations  |
...
|VNRfi                |ERROR   |Invalid parent concept code                              |Found 457 codes with invalid parent concept codes |
