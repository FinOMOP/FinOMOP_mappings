...
|FHL                  |ERROR   |APPROVED mappingStatus with concepts outdated            |58 conceptNames are outdated, 10 domainIds are outdated, 37 standardConcepts have changed to non-standard    |
...
|HPN                  |ERROR   |APPROVED mappingStatus with concepts outdated            |6 conceptNames are outdated, 3 domainIds are outdated, 7 standardConcepts have changed to non-standard       |
...
|ICD8fi               |ERROR   |APPROVED mappingStatus with concepts outdated            |136 conceptNames are outdated, 363 domainIds are outdated, 282 standardConcepts have changed to non-standard |
...
|ICD9fi               |ERROR   |APPROVED mappingStatus with concepts outdated            |286 conceptNames are outdated, 227 domainIds are outdated, 133 standardConcepts have changed to non-standard |
...
|ICD10fi              |ERROR   |APPROVED mappingStatus with valid domain combination     |Found 18 codes with invalid domain combinations                                                              |
...
|NCSPfi               |ERROR   |APPROVED mappingStatus with concepts outdated            |316 conceptNames are outdated, 261 domainIds are outdated, 534 standardConcepts have changed to non-standard |
...
|SNOMED2fi            |ERROR   |APPROVED mappingStatus with concepts outdated            |206 standardConcepts have changed to non-standard                                                            |
...
|REIMB                |ERROR   |APPROVED mappingStatus with concepts outdated            |6 conceptNames are outdated, 46 domainIds are outdated, 7 standardConcepts have changed to non-standard      |
...
|SPAT                 |ERROR   |APPROVED mappingStatus with concepts outdated            |4 conceptNames are outdated, 34 domainIds are outdated, 16 standardConcepts have changed to non-standard     |
...
|HPO                  |ERROR   |APPROVED mappingStatus with concepts outdated            |3 conceptNames are outdated, 4 domainIds are outdated                                                        |
...
|ProfessionalCode     |ERROR   |APPROVED mappingStatus with concepts outdated            |6 conceptNames are outdated, 11 domainIds are outdated, 22 standardConcepts have changed to non-standard     |
