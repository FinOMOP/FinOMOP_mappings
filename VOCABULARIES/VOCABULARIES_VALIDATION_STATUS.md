...
|FHL                  |WARNING |Not APPROVED mappingStatus with concepts outdated        |58 conceptNames are outdated, 10 domainIds are outdated, 37 standardConcepts have changed to non-standard    |
...
|HPN                  |WARNING |Not APPROVED mappingStatus with concepts outdated        |6 conceptNames are outdated, 3 domainIds are outdated, 7 standardConcepts have changed to non-standard       |
...
|ICD8fi               |ERROR   |APPROVED mappingStatus with concepts outdated            |29 conceptNames are outdated, 72 domainIds are outdated, 76 standardConcepts have changed to non-standard    |
|ICD8fi               |WARNING |Not APPROVED mappingStatus with concepts outdated        |107 conceptNames are outdated, 291 domainIds are outdated, 206 standardConcepts have changed to non-standard |
...
|ICD9fi               |ERROR   |APPROVED mappingStatus with concepts outdated            |275 conceptNames are outdated, 214 domainIds are outdated, 133 standardConcepts have changed to non-standard |
|ICD9fi               |WARNING |Not APPROVED mappingStatus with concepts outdated        |11 conceptNames are outdated, 13 domainIds are outdated                                                      |
...
|ICD10fi              |ERROR   |APPROVED mappingStatus with concepts outdated            |63 standardConcepts have changed to non-standard                                                             |
...
|ICD10fi              |ERROR   |APPROVED mappingStatus with valid domain combination     |Found 12 codes with invalid domain combinations                                                              |
...
|LABfi                |ERROR   |APPROVED mappingStatus with concepts outdated            |1 conceptNames are outdated                                                                                  |
...
|LABfi_TKU            |ERROR   |APPROVED mappingStatus with concepts outdated            |2 conceptNames are outdated                                                                                  |
...
|LABfi_HUS            |ERROR   |APPROVED mappingStatus with concepts outdated            |3 conceptNames are outdated                                                                                  |
...
|MEDSPECfi            |ERROR   |APPROVED mappingStatus with concepts outdated            |1 standardConcepts have changed to non-standard                                                              |
...
|MICROBEfi            |ERROR   |APPROVED mappingStatus with concepts outdated            |48 conceptNames are outdated, 7 domainIds are outdated                                                       |
...
|MICROBEfi_TKU        |ERROR   |APPROVED mappingStatus with concepts outdated            |28 conceptNames are outdated                                                                                 |
...
|NCSPfi               |ERROR   |APPROVED mappingStatus with concepts outdated            |134 conceptNames are outdated, 55 domainIds are outdated, 71 standardConcepts have changed to non-standard   |
|NCSPfi               |WARNING |Not APPROVED mappingStatus with concepts outdated        |182 conceptNames are outdated, 206 domainIds are outdated, 463 standardConcepts have changed to non-standard |
...
|SNOMED2fi            |ERROR   |APPROVED mappingStatus with concepts outdated            |37 standardConcepts have changed to non-standard                                                             |
|SNOMED2fi            |WARNING |Not APPROVED mappingStatus with concepts outdated        |165 standardConcepts have changed to non-standard                                                            |
...
|REIMB                |WARNING |Not APPROVED mappingStatus with concepts outdated        |6 conceptNames are outdated, 46 domainIds are outdated, 7 standardConcepts have changed to non-standard      |
...
|SPAT                 |ERROR   |APPROVED mappingStatus with concepts outdated            |2 conceptNames are outdated, 18 domainIds are outdated, 9 standardConcepts have changed to non-standard      |
|SPAT                 |WARNING |Not APPROVED mappingStatus with concepts outdated        |2 conceptNames are outdated, 16 domainIds are outdated, 7 standardConcepts have changed to non-standard      |
...
|VNRfi                |ERROR   |APPROVED mappingStatus with concepts outdated            |5 standardConcepts have changed to non-standard                                                              |
...
|ICPC                 |ERROR   |APPROVED mappingStatus with concepts outdated            |5 standardConcepts have changed to non-standard                                                              |
...
|HPO                  |WARNING |Not APPROVED mappingStatus with concepts outdated        |3 conceptNames are outdated, 4 domainIds are outdated                                                        |
...
|ProfessionalCode     |WARNING |Not APPROVED mappingStatus with concepts outdated        |6 conceptNames are outdated, 11 domainIds are outdated, 22 standardConcepts have changed to non-standard     |
...
|FGVisitType          |ERROR   |APPROVED mappingStatus with concepts outdated            |119 conceptNames are outdated, 2 domainIds are outdated                                                      |
...
|LABfi_ALL            |ERROR   |APPROVED mappingStatus with concepts outdated            |5 conceptNames are outdated                                                                                  |
