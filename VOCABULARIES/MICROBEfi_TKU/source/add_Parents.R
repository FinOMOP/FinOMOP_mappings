# Read the MICROBEfi_TKU Usagi file
# Given no parent information add `ADD_INFO:sourceParents` and `ADD_INFO:sourceParentVocabulary` columns as NA

# Read the MICROBEfi_TKU usagi file
usagi_file <- readr::read_csv("../../VOCABULARIES/MICROBEfi_TKU/MICROBEfi_TKU.usagi.csv")
...
usagi_file_updated |> readr::write_csv("../../VOCABULARIES/MICROBEfi_TKU/MICROBEfi_TKU.usagi.csv", na = "")
