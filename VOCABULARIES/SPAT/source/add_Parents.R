# Read the SPAT Usagi and source `387_1385126324219.xls` files
...
# Given that all the parent codes are from the `SPAT` vocabulary then `ADD_INFO:sourceParentVocabulary` column will NA


# Read the Usagi file
usagi_file <- readr::read_csv("../../VOCABULARIES/SPAT/SPAT.usagi.csv")

# Read the source file with parent information
source_file <- readxl::read_xlsx("../../VOCABULARIES/SPAT/source/387_1385126324219.xls")
...
usagi_file_updated |> readr::write_csv("../../VOCABULARIES/SPAT/SPAT.usagi.csv", na = "")
