# Read the UNITfi_ALL Usagi file
# Given no parent information add `ADD_INFO:sourceParents` and `ADD_INFO:sourceParentVocabulary` columns as NA

# Read the UNITfi usagi file
usagi_file <- readr::read_csv("../../VOCABULARIES/UNITfi_ALL/UNITfi_ALL.usagi.csv")
...
usagi_file_updated |> readr::write_csv("../../VOCABULARIES/UNITfi_ALL/UNITfi_ALL.usagi.csv", na = "")
